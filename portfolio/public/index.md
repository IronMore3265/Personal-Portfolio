...
This is the Markdown representation of <https://nabil-pp.vercel.app/>, served for clients that request `Accept: text/markdown` or append `?format=md`.

## About

Nabil Fuad Raiyan is an Industrial & Production Engineering (IPE) graduate from BUET who works at the intersection of industrial engineering and data analysis — process optimization, Lean/5S implementation, multi-criteria decision analysis, and analytics with Excel, SQL, Power BI, and Python.
...
- Email: nfraiyan122002@gmail.com
- Structured index: [/llms.txt](https://nabil-pp.vercel.app/llms.txt)
